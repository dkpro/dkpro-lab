...
public class FlexTableTest {
	...
	public void testTranspose() {
		...
		// TODO MW: Create a proper toString() for FlexTable that outputs the table in a nice format.
		...
		Assert.assertEquals("The first column should have the header 'Row 1'", columnIds[0], "Row 1");
		...
		for(String colID : columnIds)
			Assert.assertTrue("The row should contain column ID " + colID, firstRow.containsKey(colID));
	}
